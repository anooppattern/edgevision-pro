...
(async () => {
  ...
  await p.goto('file:///home/user/edgevision-pro/deck/EdgeVision-Retail-QSR-IntelEvent.html',{waitUntil:'networkidle',timeout:60000});
  ...
  await p.pdf({path:'/home/user/edgevision-pro/deck/EdgeVision-Retail-QSR-IntelEvent.pdf',printBackground:true,preferCSSPageSize:true,width:'13.333in',height:'7.5in',margin:{top:0,right:0,bottom:0,left:0}});
